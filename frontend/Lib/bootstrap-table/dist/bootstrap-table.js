		...
		function() {
			...
			_createClass(BootstrapTable, [{
				...
				value: function initContainer() {
					...
					/* 自添加，解决宽度设置无效*/
					$(".table").css({"table-layout":"fixed","word-break":"break-all","word-wrap":"break-word"});
					/*end*/
					...
					this.header.fields.forEach(function(field, j) {
						...
						if(column.checkbox || column.radio) {
							...
							if(_this7.options.cardView) {
								...
								//自修改，添加美化滚动条（class='mCustomScrollbar' data-mcs-theme='minimal-dark' data-mcs-axis='x'）
								text = "<td class='mCustomScrollbar' data-mcs-theme='minimal-dark' data-mcs-axis='x'".concat(id_).concat(class_).concat(style_).concat(data_).concat(rowspan_).concat(colspan_).concat(title_, ">").concat(value, "</td>");
							}
						}
