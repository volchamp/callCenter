...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ setVal
       setVals:function($selectManiaEl, str){
       		var thisEngine = this;
			var $originalSelect = $selectManiaEl.data('selectMania-originalSelect');
			thisEngine.clear($selectManiaEl);
			thisEngine.setOneValOriginals($originalSelect, str);
			thisEngine.updateClean($selectManiaEl);
			Binds.bind($selectManiaEl);
       },
       ...
       setOneValOriginals:function($originalSelect, str){
       	var $searchOpt = $originalSelect.find('option[value="'+str+'"]').filter(function() {
				return true;
			});
			var $foundOption = $searchOpt.first();
				$foundOption[0].selected = true;
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ set
		...
		set: function(values) {
         ...
         sets:function(values){
         	if(Engine.controlTarget(this, ['isSingle','isInitialized'])) {
					var $selectManiaEl = this.data('selectMania-element');
					Engine.setVals($selectManiaEl, values);
			}			
         },
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ clear
